...
Proyecto/
│
├── CleanData/              # Archivos procesados y listos para modelado
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20733748.svg)](https://doi.org/10.5281/zenodo.20733748)

4. Abre los notebooks en el siguiente orden:
   - `datos.ipynb`
   - `modelos.ipynb`
   - `visualizacion.ipynb`
